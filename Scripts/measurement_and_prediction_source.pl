...
"usage: measurement_and_prediction_source.pl [--model='MANAGED ...'] measurement_stream_port|none measurement_buffer_port|none ctrl_port stream_port|none buffer_port|none numitems period text-generator\n\n".
