...
$gen="make_alternate.pl 'make_sine.pl 10 0 100 1000 0.1' 'make_zeros.pl 1000 0.1'";
#$gen="gen_numbers.pl 0.1";

#$gen="make_sine.pl 10 0 100 1000000 0.1";
...
#$cmd = "$gen | text2measure 10000 source:stdio:stdin target:stdio:stdout connect:tcp:$inputmeasurest| measurebuffer 10000 source:stdio:stdin server:tcp:$inputmeasurebuf target:stdio:stdout | bin/I386/LINUX/wavelet_streaming_server daub8 12 transform source:stdio:stdin target:stdio:stdout connect:tcp:$waveletstream | bin/I386/LINUX/wavelet_streaming_client reconst source:stdio:stdin | text2measure 10000 source:stdio:stdin connect:tcp:$outputmeasurest target:stdio:stdout | measurebuffer 10000 source:stdio:stdin server:tcp:$outputmeasurebuf";

$cmd = "$gen | text2measure 10000 source:stdio:stdin target:stdio:stdout connect:tcp:$inputmeasurest| measurebuffer 10000 source:stdio:stdin server:tcp:$inputmeasurebuf target:stdio:stdout | bin/I386/LINUX/wavelet_streaming_server daub8 4 transform source:stdio:stdin target:stdio:stdout | bin/I386/LINUX/wavelet_predict conf.cfg source:stdio:stdin target:stdio:stdout connect:tcp:$waveletstream | bin/I386/LINUX/wavelet_streaming_client reconst nodelay source:stdio:stdin | text2measure 10000 source:stdio:stdin connect:tcp:$outputmeasurest target:stdio:stdout | measurebuffer 10000 source:stdio:stdin server:tcp:$outputmeasurebuf";
