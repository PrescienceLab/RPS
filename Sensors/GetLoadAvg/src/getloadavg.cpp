...
/* #define LDAV_USE_UPTIME will do what you think --PAD */
...
#if defined(sun) /*  && defined(USG) -- PAD */
#define SUNOS_5
#endif
...
#if !defined(LDAV_SYMBOL) && ((defined(hpux) && !defined(hp9000s300)) || defined(_SEQUENT_) || defined(SVR4) || defined(ISC) || defined(sgi) || (defined (ardent) && defined (titan)) || defined (_AIX) || defined(SUNOS_5) )  
/* SUNOS_5 added by PAD - pigfuckers at sun changed symbol */
...
#if defined(HAVE_FCNTL_H) || defined(_POSIX_VERSION) || defined(WIN32)
#include <fcntl.h>
#else
#include <sys/file.h>
#endif
...
int
RPSgetloadavg (double loadavg[], int nelem)
{
#ifdef WIN32
  int i;
  for (i=0;i<nelem;i++) { 
